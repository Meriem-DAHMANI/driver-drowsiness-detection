...
# function calculationg the aspect ratio for the eye
# by using euclidean distance function 
def Detect_Eye(eye):
...
while True:
	...
	for face in faces:
        ...
        # the points allocation for the left ayes (from 42 to 47 in .DAT file)
        ...
        # the points allocation for the left ayes (from 36 to 41 in .DAT file)
        ...
        # calculationg the aspect ratio for the left and right eye
        ...
        # we use this value to decide whether the person's eyes are close or not
		if Eye_Rat < 0.25:
